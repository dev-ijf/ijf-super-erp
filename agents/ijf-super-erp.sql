...
CREATE TABLE core_settings (
    ...
    UNIQUE KEY unique_setting_per_school (school_id, setting_key),
...
CREATE TABLE core_users (
    ...
    phone VARCHAR(20),
    role ENUM('superadmin', 'school_finance', 'parent','teacher') NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (school_id) REFERENCES core_schools(id)
);
...
CREATE TABLE core_students (
    ...
    child_status ENUM('Kandung', 'Tiri', 'Angkat'),
    address TEXT,
    province_id INT,
    city_id INT,
    district_id INT, 
...
CREATE TABLE tuition_products (
    ...
    payment_type ENUM('monthly', 'installment', 'one_time') NOT NULL,
